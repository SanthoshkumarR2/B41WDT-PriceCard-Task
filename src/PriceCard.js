        ...
        <div className="card mb-5 mb-lg-0">
          <div className="card-body">
            ...
            <ul className="fa-ul">
              ...
              <li className={props.data.communityAccesEnabler?"":"text-muted"}><span className="fa-li"><i className={props.data.communityAccesEnabler?"fas fa-check":"fas fa-times"}></i></span>{props.data.communityAcces}</li>
              ...
              <li className={props.data.subDomainEnabler?"fw-bold":"text-muted"}><span className="fa-li"><i className={props.data.subDomainEnabler?"fas fa-check":"fas fa-times"}></i></span>{props.data.subDomain}</li>
